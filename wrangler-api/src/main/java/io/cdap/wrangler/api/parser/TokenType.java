...
public enum TokenType implements Serializable {
   ...
   * This type is associated with tokens that represent byte sizes with units (KB, MB, GB, TB).
   * For example: "10KB", "1.5MB", "2GB", "1TB".
   */
  BYTE_SIZE,

  /**
   * Represents the enumerated type for the object of type {@code TimeDuration}.
   * This type is associated with tokens that represent time durations with units (ms, s, m, h, d).
   * For example: "150ms", "5s", "10m", "2h", "1d".
   */
  TIME_DURATION,
