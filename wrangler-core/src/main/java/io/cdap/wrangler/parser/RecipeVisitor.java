...
public final class RecipeVisitor extends DirectivesBaseVisitor<RecipeSymbol.Builder> {
  ...
  /**
   * A Directive can consist of a byte size field. This visitor method extracts the
   * byte size value into a token type <code>ByteSize</code>.
   */
  @Override
  ...
  /**
   * A Directive can consist of a time duration field. This visitor method extracts the
   * time duration value into a token type <code>TimeDuration</code>.
   */
  @Override
